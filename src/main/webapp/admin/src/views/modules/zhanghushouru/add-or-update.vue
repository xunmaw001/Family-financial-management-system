<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="账户名称" prop="zhanghumingcheng">
          <el-input v-model="ruleForm.zhanghumingcheng" 
              placeholder="账户名称" clearable  :readonly="ro.zhanghumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="账户名称" prop="zhanghumingcheng">
              <el-input v-model="ruleForm.zhanghumingcheng" 
                placeholder="账户名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="收入时间" prop="shourushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.shourushijian" 
                type="datetime"
                :readonly="ro.shourushijian"
                placeholder="收入时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shourushijian" label="收入时间" prop="shourushijian">
              <el-input v-model="ruleForm.shourushijian" 
                placeholder="收入时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="收入详情" prop="shouruxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="收入详情"
                  v-model="ruleForm.shouruxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shouruxiangqing" label="收入详情" prop="shouruxiangqing">
                    <span>{{ruleForm.shouruxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.shourushijian = this.getCurDateTime()
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhanghushouru/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhanghushouruCrossAddOrUpdateFlag = false;
						 this.parent.search();
